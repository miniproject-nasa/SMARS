...
class GameService {
  static const String baseUrl = "http://172.16.1.124:5000/api/games";
  ...
  static Future<Map<String, dynamic>> getUserSettings() async {
    try {
      final headers = await _getHeaders();
      final response = await http.get(
        Uri.parse("http://172.16.1.124:5000/api/settings"),
        headers: headers,
      );
  ...
  static Future<Map<String, dynamic>> getUserAchievements() async {
    try {
      final headers = await _getHeaders();
      final response = await http.get(
        Uri.parse("http://172.16.1.124:5000/api/settings/achievements"),
        headers: headers,
      );
